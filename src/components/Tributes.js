      ...
      <div className="row3">
        <div className="row3_row">
          <div className="row3_image">
            ...
            <p>
              The story of modern Nigeria will never be complete without a
              chapter on Queen Elizabeth ll, a towering global personality and
              an outstanding leader. She dedicated her life to making her
        ...
        <div className="row3_row">
          <div className="row3_image">
            ...
            <p>
              ...
              continuity and unity for over 70 years. I remember her as a friend
              of France, a kind-hearted queen who has left a lasting impression
              on her country and her century.”
            </p>
          </div>
          <div className="name">
